...
OBJS_mainRPG = $(OBJDIR)/main.o $(OBJDIR)/Personnage.o $(OBJDIR)/Competence.o $(OBJDIR)/Vector2D.o $(OBJDIR)/JeuSDL.o $(OBJDIR)/Jeu.o
OBJS_JeuSDL = $(OBJDIR)/JeuSDL.o $(OBJDIR)/Personnage.o $(OBJDIR)/Competence.o $(OBJDIR)/Vector2D.o 
...
$(OBJDIR)/main.o:$(SRCDIR)/main.cpp $(SRCDIR)/Personnage.h $(SRCDIR)/Competence.h $(SRCDIR)/Vector2D.h $(SRCDIR)/JeuSDL.h $(SRCDIR)/Jeu.h
	$(CC) $(CPPFLAGS) -c $(SRCDIR)/main.cpp -o $(OBJDIR)/main.o            

$(OBJDIR)/JeuSDL.o: $(SRCDIR)/JeuSDL.cpp $(SRCDIR)/JeuSDL.h  $(SRCDIR)/Personnage.h $(SRCDIR)/Competence.h $(SRCDIR)/Vector2D.h $(SRCDIR)/Jeu.h
	$(CC) $(CPPFLAGS) -c $(SRCDIR)/JeuSDL.cpp -o $(OBJDIR)/JeuSDL.o $(LIBSDL)

$(OBJDIR)/Jeu.o: $(SRCDIR)/Personnage.h $(SRCDIR)/Personnage.cpp
